...
/**
 * Orthovaria's own AI treatment plan assistant. Same shape as dental's
 ...
 * based) and every conversation is scoped to Specialty::ORTHOPEDICS. See
 * app/Services/AiConversationService.php's docblock for the shared-engine
 * rationale, and app/Http/Controllers/Api/Orthopedics/ClientController.php's
...
class AiConversationController extends Controller
{
    ...
    {
        return Specialty::query()->where('key', Specialty::ORTHOPEDICS)->firstOrFail();
    }
}
