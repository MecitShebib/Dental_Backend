...
/**
 * Orthovaria's own clinical Dashboard endpoint. See
 * app/Http/Controllers/Api/Orthopedics/ClientController.php's docblock.
 */
class DashboardController extends Controller
{
    ...
    public function stats(Request $request)
    {
        ...
        $stats = $this->dashboardStats->stats(
            ...
            specialtyKey: Specialty::ORTHOPEDICS,
        );
