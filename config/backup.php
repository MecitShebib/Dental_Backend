...
return [
    ...
    'backup' => [
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. Defaults to the
             * local disk; add 's3' (or another configured disk) via BACKUP_DISKS
             * for off-server storage once cloud credentials are available.
             */
